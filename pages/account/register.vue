	...
	<view class="register" :style="{height:height+'px'}">
		<view>
			...
			<view class="now_login">
				<text>已有账号?</text>
				<text class="blue-font" @click="pageUrl('login')">去登陆</text>
			</view>
		</view>
		<view class="agree">
			<view class="flex-center">
				<u-checkbox @change="checkboxChange" v-model="check" :name="1" shape="circle">
				</u-checkbox>
				<text style="margin-left: 10rpx;">点击注册代表你同意</text>
				<text @click="pageUrl('treaty')" class="protocol">《医来顺用户协议》</text>
			</view>
