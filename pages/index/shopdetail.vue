<template>
	<view class="detail">
			...
			<view class="white-back">
				...
				<view class="price ">
					<view class="flex-left-right">
						<view><text class="fs-13 ">市场价:</text>
							<text class="fs-23 red-font bold"
								v-if="ware.sku.length==1">￥{{ware.sku[0].market_price}}</text>
							<text class="fs-23 red-fon bold" v-else>￥{{minPrice}}-{{maxPrice}}</text>
						</view>

						<view class="fs-13 gray-font">月销{{ware.sales}}件</view>
					</view>
					<view class="fs-13 gray-font">挂网价:￥209.99</view>
				</view>

			</view>
		</view>
		<view class="delivery white-back">
			<view class=" flex" @click="buyGood">
				<text style="margin-right: 75rpx;">已选</text>
				<view class="flex-left-right u-flex-1">
					<view>50个/盒</view>
					<view class="fs-12 gray-font">1件
			...
			<view class=" flex" @click="showParams=true">
				<text style="margin-right: 75rpx;">参数</text>
				<view class="flex-left-right u-flex-1">
					<view>品牌 型号...</view>
					<u-icon name="arrow-right" color="gray" size="24"></u-icon>
				</view>
		...
		<view>
			<view class="flex-center flex-column more-info white-back">
		...
		<view class="addcart-detail">
			<view class="flex-left-right">
				...
				<view class="flex-center flex-column">
					...
					<text class="fs-13">收藏</text>
				</view>

				<view class="flex-center flex-column" @click="$doubleClick(shopcartPage)">
					<text class="iconfont icon-gouwuche21"></text>
				...
				<view class="submit flex">
					...
					<view class="add" @click="buyGood">
						加入购物车
					</view>
					<view class="now-buy" @click="buyGood">
						立刻购买
					</view>
				</view>
			</view>
		...
		<u-popup mode="bottom" v-model="showCart" border-radius="20">
